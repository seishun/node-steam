...
function SteamClient(username, password) {
  ...
  var cmclient = new (require('./cmclient.js'))();
  cmclient.username = username;
  cmclient.password = password;
  cmclient.emitter = this;
  cmclient.connection.emitter = this; // TODO: get rid of this mess somehow
  ...
  this.joinChat = function(steamID) {
    ...
    body.writeInt32LE(lo, 0);
    body.writeInt32LE(hi, 4);
    body.writeInt8(0, 8);
