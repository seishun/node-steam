...
var MsgHdrProtoBuf = {
  ...
  serialize: function(object) {
    ...
    buffer.writeInt32LE(object.msg | protoMask || EMsg.Invalid, 0);
  ...
  parse: function(buffer) {
    ...
    object.msg = buffer.readInt32LE(0) & ~protoMask;
...
var MsgGCHdrProtoBuf = {
  ...
  serialize: function(object) {
    ...
    buffer.writeUInt32LE(object.msg | protoMask || 0, 0);
    buffer.writeInt32LE(object.headerLength || 0, 4);
    bufProto.copy(buffer, 8);
  ...
  parse: function(buffer) {
    ...
    object.msg = buffer.readUInt32LE(0) & ~protoMask;
    object.headerLength = buffer.readInt32LE(4);
