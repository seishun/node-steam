...
Steam.EContentDownloadSourceType = {
  Invalid: 0,
  CS: 1,
  CDN: 2,
  LCS: 3,
...
Steam.EWorkshopEnumerationType = {
  RankedByVote: 0,
  Recent: 1,
  Trending: 2,
  FavoriteOfFriends: 3,
...
Steam.EPublishedFileVisibility = {
  Public: 0,
  FriendsOnly: 1,
  Private: 2,
};

Steam.EWorkshopFileAction = {
  Played: 0,
  Completed: 1,
};

Steam.EEconTradeResponse = {
  Accepted: 0,
  Declined: 1,
...
Steam.EDRMBlobDownloadErrorDetail = {
  None: 0,
  DownloadFailed: 1,
  TargetLocked: 2,
  OpenZip: 3,
...
Steam.EClientStatAggregateMethod = {
  LatestOnly: 0,
  Sum: 1,
  Event: 2,
  Scalar: 3,
