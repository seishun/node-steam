...
prototype.acceptGroup = function(steamIdGroup) {
  this._send(EMsg.ClientAcknowledgeClanInvite, schema.MsgClientAcknowledgeClanInvite.serialize({
    steamIdGroup: toClanID(steamIdGroup),
    acceptInvite: true
  }));
};
...
prototype.groupInvite = function(steamIdGroup, steamIdInvited) {
  this._send(EMsg.ClientInviteUserToClan, schema.MsgClientInviteUserToClan.serialize({
    steamIdInvited: steamIdInvited,
    steamIdGroup: toClanID(steamIdGroup),
    unknown: true
  }));
