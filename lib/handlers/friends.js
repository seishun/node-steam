...
handlers[EMsg.ClientFriendsList] = function(data) {
  ...
  for(var friend in list.friends)
  {
    steamID = new SteamID(list.friends[friend].ulfriendid);
    this.emit('relationship', list.friends[friend].ulfriendid, list.friends[friend].efriendrelationship, steamID.accountType);
  }
};
