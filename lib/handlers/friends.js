...
Steam.SteamFriends = function SteamFriends(steamClient) {
...
prototype.setPersonaName = function(name) {
  this._send({ msg: EMsg.ClientChangeStatus, proto: {} }, new schema.CMsgClientChangeStatus({
...
prototype.sendMessage = function(target, message, type) {
  ...
  if (target.accountType == Steam.EAccountType.Individual || target.accountType == Steam.EAccountType.ConsoleUser) {
    this._send({ msg: EMsg.ClientFriendMsg, proto: {} }, new schema.CMsgClientFriendMsg({
    ...
    this._send({ msg: EMsg.ClientChatMsg }, ByteBuffer.concat([chatMsg.encode(), payload]));
  }
};

prototype.addFriend = function(steamID) {
  this._send({ msg: EMsg.ClientAddFriend, proto: {} }, new schema.CMsgClientAddFriend({
    steamidToAdd: steamID
  }));
};

prototype.removeFriend = function(steamID) {
  this._send({ msg: EMsg.ClientRemoveFriend, proto: {} }, new schema.CMsgClientRemoveFriend({
    friendid: steamID
  }));
};

prototype.joinChat = function(steamID) {
  this._send({ msg: EMsg.ClientJoinChat }, new schema.MsgClientJoinChat({
...
prototype.leaveChat = function(steamID) {
  ...
  this._send({ msg: EMsg.ClientChatMemberInfo }, ByteBuffer.concat([leaveChat.encode(), payload.flip()]));
  delete this.chatRooms[steamID];
};

prototype.lockChat = function(steamID) {
  this._send({ msg: EMsg.ClientChatAction }, new schema.MsgClientChatAction({
    steamIdChat: toChatID(steamID),
...
prototype.chatInvite = function(steamIdChat, steamIdInvited) {
  this._send({ msg: EMsg.ClientChatInvite, proto: {} }, new schema.CMsgClientChatInvite({
...
prototype.getSteamLevel = function(steamids, callback) {
  ...
  this._send({ msg: EMsg.ClientFSGetFriendsSteamLevels, proto: {} }, new schema.CMsgClientFSGetFriendsSteamLevels({
...
prototype.requestFriendData = function(steamIdList, requestedData) {
  this._send({ msg: EMsg.ClientRequestFriendData, proto: {} }, new schema.CMsgClientRequestFriendData({
    friends: steamIdList,
...
prototype.setIgnoreFriend = function(steamID, setIgnore, callback) {
  this._send({ msg: EMsg.ClientSetIgnoreFriend }, new schema.MsgClientSetIgnoreFriend({
