...
prototype.webLogOn = function(callback) {
  ...
  var req = require('https').request(options, function(res) {
    if (res.statusCode == 200) {
      ...
      self._send({ msg: EMsg.ClientRequestWebAPIAuthenticateUserNonce, proto: {} }, new schema.CMsgClientRequestWebAPIAuthenticateUserNonce(), function(data) {
...
prototype.gamesPlayed = function(appIDs) {
  this._send({ msg: EMsg.ClientGamesPlayed, proto: {} }, new schema.CMsgClientGamesPlayed({
...
handlers[EMsg.ClientLogOnResponse] = function(data) {
  ...
  if (eresult == EResult.OK) {
    ...
    this._heartBeatFunc = setInterval(function() {
      this._send({ msg: EMsg.ClientHeartBeat, proto: {} }, new schema.CMsgClientHeartBeat());
...
handlers[EMsg.ClientNewLoginKey] = function(data) {
  ...
  this._send({ msg: EMsg.ClientNewLoginKeyAccepted, proto: {} }, new schema.CMsgClientNewLoginKeyAccepted({
