...
prototype.logOn = function(logOnDetails, options) {
  ...
  options = options || {};
  this._options = {
    useSocks: options.useSocks || false,
  ...
  if(this._options.useSocks)
    this.emit('debug', 'using socks proxy ' + this._options.socksHost + ':' + this._options.socksPort);

  this._connection = new (require('../connection')(this._options.useSocks))(this._options.socksHost, this._options.socksPort);
