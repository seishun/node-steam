...
SteamClient.prototype._netMsgReceived = function(data) {
  ...
  if (targetJobID in this._jobs || eMsg in this._handlers) {
    (this._jobs[targetJobID] || this._handlers[eMsg]).call(this, data, sourceJobID != '18446744073709551615' && function(header, body, callback) {
      if (header.proto)
...
//  var encRequest = schema.MsgChannelEncryptRequest.decode(data);
  ...
  this._send({ msg: EMsg.ChannelEncryptResponse }, body.flip());
};
...
handlers[EMsg.ChannelEncryptResult] = function(data) {
  ...
  this._send({ msg: EMsg.ClientLogon, proto: {} }, new schema.CMsgClientLogon(this._logOnDetails));
};
