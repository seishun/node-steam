...
function SteamClient() {
  ...
  // this is a temporary hack. the user should be responsible for creating these
  Steam.SteamUser(this);
  Steam.SteamFriends(this);
  Steam.SteamTrading(this);
  Steam.SteamUnifiedMessages(this);
  Steam.SteamGameCoordinator(this);
